...
>(
    ...
    let theta = challenger.get_challenge();
    ...
    for instance in instance.iter() {
        ...
        challenger.observe_elements(&instance_evals);
        // }
    }
    ...
    for advice in advice.iter() {
        ...
        // }
        challenger.observe_elements(&advice_evals);
    }
    ...
    let instances = instance
        ...
        // .zip(lookups.iter())
        .flat_map(|((instance, advice), permutation)| {
            iter::empty()
                .chain(
                    pk.vk
                        .cs
