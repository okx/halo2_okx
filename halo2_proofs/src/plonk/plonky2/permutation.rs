...
use crate::plonk::{ plonky2::Scalar, circuit::{Any, Column} };
...
#[derive(Clone, Debug)]
pub(crate) struct VerifyingKey<F: Scalar<D>, const D: usize> {
    commitments: Vec<F>,
}

/// The proving key for a single permutation argument.
#[derive(Clone, Debug)]
pub(crate) struct ProvingKey<F: Scalar<D>, const D: usize> {
